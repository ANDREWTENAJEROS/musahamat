...
CREATE TABLE `transactions` (
  ...
  `transaction_details_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `guest_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `guest` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT primary key,
  `guestFname` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `guestLname` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
