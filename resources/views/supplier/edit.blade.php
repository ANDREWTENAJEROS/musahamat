    ...
    {!! Form::open(['action' => ['supplierController@update', $supplier->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        <div class="form-group">
            ...
            <div class="row">
                ...
                {{Form::number('business_tel', $supplier->business_tel, ['class' => 'form-control', 'placeholder' => ' '])}}
                </div>

                <div class="col-md-4 col-sm-4">
                {{Form::label('business_fax', 'fax number:')}}
                {{Form::number('business_fax', $supplier->business_fax, ['class' => 'form-control', 'placeholder' => ' '])}}
                </div>

                <div class="col-md-4 col-sm-4">
                 {{Form::label('category', 'Category:')}}
                 {{Form::text('business_info1', $supplier->business_info1, ['class' => 'form-control', 'required' => 'required', 'placeholder' => ' '])}}
            </div>
